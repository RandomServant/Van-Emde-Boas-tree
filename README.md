...
===============
6\.1. Атрибуты узла дерева ван Эмбде Боаса <a name="Атрибуты"></a>
------------------
...
```
0 Coincidence Find - 1200ns
Insert - 900ns
Remove - 800ns
-1 Coincidence SuccessorVEB - 1000ns
-1 Coincidence PredecessorVEB - 1000ns
-1 Error
-1 Coincidence
```
