...
- [8. Тестирование](#Тестирование)
  ...
  - [8.6. Генератор тестов](#Генератортестов)
- [9. Проверка производительности](#Производительность)
- [10. Список литературы](#Списоклитературы)
...
8\.3. Заполнение файлов .in <a name=".in"></a>
--------------
...
### 8.3.1. Сокращение команд <a name="Сокращениекоманд"></a>
...
### 8.3.2. Пример <a name="Пример.in"></a>
```
16
f 10
i 2
...
e
```
8\.4. Заполнение файлов .ans <a name=".ans"></a>
--------------
Поочередно на каждой строке заполняется ожидаемый вывод.

### 8.4.1. Пример <a name="Пример.ans"></a>
```
0
-1
-1
...
-1
```
8\.5. Вывод в файл .out <a name=".out"></a>
--------------
...
### 8.5.1. Пример <a name="Пример.out"></a>
```
0 OK Find - 1200ns
Insert - 900ns
Remove - 800ns
...
8\.6. Генератор тестов <a name="Генератортестов"></a>
---------------
Создан для проверки производительности.
Создаёт указанное количество фалов в указанной папке.
```c++
TestsGenerator *test = new TestsGenerator(/*Путь к папке с файлами*/, /*Количество файлов*/);
test->GenerateTests(/*Тестируемая операция*/);
test->StartTests(/*Тестируемая операция*/);
```

Примечание: тестируемая операция - параметр, принимающий сокращенные команды (смотрите п. [8.3.1.](#Сокращениекоманд))

---------------------
9\. Проверка производительности <a name="Производительность"></a>
===================
...
------------------------
10\. Список литературы <a name="Списоклитературы"></a>
=================
